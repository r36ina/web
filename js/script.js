...
document.querySelector('.reviews__cell-but-right').addEventListener('click', showPrevReview);
document.querySelector('.reviews__cell-but-left').addEventListener('click', showNextReview);
